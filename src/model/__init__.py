...
from .transformer import TransformerModel, KlgAttnTransformerModel
...
def build_model(params, dico):
    ...
    if params.encoder_only:
        ...
        if params.knowledge != 'none':
            model = KlgAttnTransformerModel(params, dico, is_encoder=True, with_output=True)
        else:
        ...
        if params.knowledge == 'none':
            ...
            encoder = KlgAttnTransformerModel(params, dico, is_encoder=True, with_output=True)
            decoder = TransformerModel(params, dico, is_encoder=False, with_output=True)
