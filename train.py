...
def get_parser():
    ...
    # knowledge
    parser.add_argument("--knowledge", type=str, default="none", choices=["none", "simple_attn", "double_attn"],
                        help="Method to use knowledge")
    parser.add_argument("--k_emb_path", type=str, default="", help="Knowledge embedding path")

    # img
    parser.add_argument("--use_image", type=bool, default=False, help="Use image in MASS training")
    parser.add_argument("--img_feature_file", type=str, default='', help="Image feature path")

    parser.add_argument("--inter_lambda", type=float, default=0., help="Coefficient of intermedia loss")
...
def main(params):
    ...
    if params.fp16:
        ...
        if params.encoder_only:
            ...
            encoder = apex.amp.initialize(encoder, opt_level="O1")
            decoder = apex.amp.initialize(decoder, opt_level="O1")
